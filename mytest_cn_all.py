...
#train_data = "/export/scratch/for_wgong/jp_data/nq_till_2017"
train_data = "/export/scratch/for_wgong/cn_data/ns_cn_till_2015"
with open(train_data,"r",encoding="utf-8") as inf:
  for i,line in enumerate(inf):
    ...
    (name_set,symbol_set) = et.extract_ticker(headline,lang="cn",date=date)
    ### compare by symbol
    outputfile_missing = "result/cn/missing_cn_all"
    outputfile_error = "result/cn/error_cn_all"
    outputfile_right = "result/cn/right_cn_all"
    outputfile_perfect = "result/cn/perfect_cn_all"
    ## record as missing
    if len(symbol_set) == 0:
      missing_num += 1
