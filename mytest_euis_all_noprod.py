...
with open(train_data,"r",encoding="utf-8") as inf:
  for i,line in enumerate(inf):
    ...
    ### compare by symbol
    outputfile_missing = "result/eu/missing_euis_all_noprod"
    outputfile_error = "result/eu/error_euis_all_noprod"
    outputfile_right = "result/eu/right_euis_all_noprod"
    outputfile_perfect = "result/eu/perfect_euis_all_noprod"
    ## record as missing
    if len(symbol_set) == 0:
      missing_num += 1
