...
train_data = "us_data/bf_train_data_5000"
...
with open(train_data,"r",encoding="utf-8") as inf:
  for i,line in enumerate(inf):
    ...
    (name_set,symbol_set) = et.extract_ticker(headline,lang="en",region="us",date=date,data_source="bf")
    ### compare by symbol
    outputfile_missing = "result/us/missing_bf5000"
    outputfile_error = "result/us/error_bf5000"
    outputfile_right = "result/us/right_bf5000"
    outputfile_perfect = "result/us/perfect_bf5000"
    ## record as missing
    if len(symbol_set) == 0:
      missing_num += 1
