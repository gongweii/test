...
with open(train_data,"r",encoding="utf-8") as inf:
  for i,line in enumerate(inf):
    ...
    (name_set,symbol_set) = et.extract_ticker(headline,lang="jp",date=date)
    ### compare by symbol
    outputfile_missing = "result/jp/missing_nqos_all"
    outputfile_error = "result/jp/error_nqos_all"
    outputfile_right = "result/jp/right_nqos_all"
    outputfile_perfect = "result/jp/perfect_nqos_all"
    ## record as missing
    if len(symbol_set) == 0:
      missing_num += 1
